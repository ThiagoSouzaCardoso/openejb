...
public class SimpleRestEJB {
    ...
    public void addMovie(Movie movie) throws Exception {
        ...
        try {
            ...
            sql.setString(1, movie.getDiretor());
            sql.setString(2, movie.getTitulo());
            sql.setInt(3, movie.getAno());
            sql.execute();
        } finally {
            conn.close();
        }
    ...
    public List<Movie> getMovies() throws Exception {
        ...
        try {
            ...
            while (set.next()) {
                ...
                movie.setDiretor(set.getString("director"));
                movie.setTitulo(set.getString("title"));
                movie.setAno(set.getInt("year"));
                movies.add(movie);
            }
        } finally {
            conn.close();
    ...
    public String getMovieTitle(@PathParam("id") String id) throws Exception {
        ...
        return movies.get(Integer.parseInt(id)).getTitulo();
    }
